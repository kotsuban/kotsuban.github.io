// Reference: https://github.com/fand/vfx-js/blob/main/packages/vfx-js/src/dom-to-canvas.ts
...
export function getRectFromElement(element: HTMLElement) {
...
export default async function getCanvasFromElement(
  ...
  return new Promise((resolve, reject) => {
    ...
    img.onload = () => {
      ...
      resolve({ canvas, x: rect.x * ratio, y: rect.y * ratio });
    };
